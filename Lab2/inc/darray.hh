...
class DArray {
	...
	int *tab; // wskaznik na poczatek tablicy
	...
	DArray() {
		tab = new int[STARTSIZE]; //rezerwacja pamieci dla STARTSIZE elementow
		size = 0;
		allocatedSize = STARTSIZE; //tablica na początku ma rozmiar STARTSIZE
	}
